...
# dependencies = []
# ///
# rescind backstop artifact: plan open_mgmt_port on fw-win-02 (os windows), instance golden, language python. Rendered by rescind-render; do not edit.
import hashlib
import os
import shutil
import subprocess
...
if os.path.exists(m):
    ...
    if skip:
        ...
        run('Remove-NetFirewallRule -Name rescind-mgmt')
        os.remove(m)
