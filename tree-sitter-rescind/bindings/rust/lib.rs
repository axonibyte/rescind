//! rescind's tree-sitter grammar, as a language an editor or a test can load.
//!
...
extern "C" {
    fn tree_sitter_rescind() -> *const ();
}

/// The language this grammar defines.
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_rescind) };
