; Highlighting for rescind (docs/ROADMAP.md section 6.6 names the keywords).
;
; The rule is that what rescind treats as structure is highlighted as
; structure: an op's footprint kind, a plan's wane, a step's gate. Nothing
; here invents a category rescind does not have.
