/**
 * rescind, for editors (docs/ROADMAP.md section 6; docs/issues/0005).
 *
 * This grammar exists to highlight and to navigate, not to judge: `rescind
...
module.exports = grammar({
  ...
  rules: {
    // A file is its version line, then declarations. `rescind 0` is the first
    ...
    version: $ => seq('rescind', field('version', $.integer), $._nl),
    ...
    // rescind reports a diagnostic, and an editor would underline the wrong
    // thing.
